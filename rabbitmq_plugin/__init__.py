...
from .rabbitmq_plugin import AutoGPT_RabbitMQ, Message, userReply

PromptGenerator = TypeVar("PromptGenerator")

plugin = AutoGPT_RabbitMQ()

class AutoGPTRabbitMQ(AutoGPTPluginTemplate):
    """
    This is a template for Auto-GPT plugins.
    """
    ...
    def __init__(self):
        ...
        self._version = "0.3.1"
        self._description = "AutoGPT RabbitMQ Plugin: Interact with AutoGPT through a microservice connected to RabbitMQ."
